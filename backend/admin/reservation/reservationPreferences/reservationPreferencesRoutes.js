...
} = require("./reservationPreferencesController"); // Assuming you have a separate controller for promo codes
...
router.get("/", roleMiddleware(["admin"]), ReservationPreferencesRateLimiter, getReservationPreferencess);
