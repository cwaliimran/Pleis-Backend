...
router.post("/", roleMiddleware([ "organizer", "manager"]), createMarketing);
...
router.put("/:id", roleMiddleware([ "organizer", "manager"]), updateMarketing);
router.delete("/:id", roleMiddleware(["organizer", "manager"]), deleteMarketing);
