...
//get presets for preset options dropdown where organization is not assigned yet

const getUnassignedPresets = async (userId) => {
  return await Presets.find({
    status: "active",
