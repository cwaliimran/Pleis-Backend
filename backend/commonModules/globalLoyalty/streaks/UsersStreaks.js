...
const globalusersStreaksSchema = new mongoose.Schema(
  {
...
globalusersStreaksSchema.index({ user: 1, companyOrganizer: 1 }, { unique: true });
const GlobalUsersStreaks = mongoose.model("GlobalUsersStreaks", globalusersStreaksSchema);
module.exports = GlobalUsersStreaks;